;; Forked from https://github.com/nvim-treesitter/nvim-treesitter/blob/master/queries/verilog/highlights.scm
...
; dpi
(dpi_spec_string) @string c_name:

(c_identifier) @function
