...
; for any one using the variable highlight
(macro_definition
...
(
  (identifier) @float
  (#any-of? @float "NaN" "NaN16" "NaN32" "Inf" "Inf16" "Inf32")
)
