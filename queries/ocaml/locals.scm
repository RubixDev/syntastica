;; Forked from https://github.com/nvim-treesitter/nvim-treesitter/blob/master/queries/ocaml/locals.scm
...
(type_binding
  (type_constructor) @definition.type
)
...
(module_type_definition
  (module_type_name) @definition.type
)
