//! The oxocarbon themes collection in this module was extracted from <https://github.com/nyoom-engineering/oxocarbon.nvim> using `auto_extract.py`
...
pub fn dark() -> ResolvedTheme {
    ResolvedTheme::new(BTreeMap::from([
        ("bg0".to_owned(), Style::color_only(22, 22, 22)),
        ...
        ("puncuation.delimiter".to_owned(), Style::new(Color::new(61, 219, 217), false, false, false, false)),
...
pub fn light() -> ResolvedTheme {
    ResolvedTheme::new(BTreeMap::from([
        ...
        ("puncuation.delimiter".to_owned(), Style::new(Color::new(255, 126, 182), false, false, false, false)),
