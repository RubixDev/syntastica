//! The nightfly themes collection in this module was extracted from <https://github.com/bluz71/vim-nightfly-colors> using `auto_extract.py`
...
pub fn nightfly() -> ResolvedTheme {
    ResolvedTheme::new(BTreeMap::from([
        ...
        ("text.diff.add".to_owned(), Style::new(Color::new(1, 22, 39), false, false, false, false)),
