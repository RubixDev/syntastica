//! The boo themes collection in this module was extracted from <https://github.com/rockerBOO/boo-colorscheme-nvim> using `auto_extract.py`
...
pub fn boo() -> ResolvedTheme {
    ResolvedTheme::new(BTreeMap::from([
        ...
        ("type.builtin".to_owned(), Style::new(Color::new(58, 114, 114), false, false, false, false)),
        ("todo".to_owned(), Style::new(Color::new(63, 52, 66), false, false, false, false)),
        ("text.environment.name".to_owned(), Style::new(Color::new(99, 176, 176), false, false, true, false)),
        ("text.environment".to_owned(), Style::new(Color::new(142, 192, 124), false, false, false, false)),
        ("text.reference".to_owned(), Style::new(Color::new(101, 74, 150), false, false, false, false)),
        ("text.math".to_owned(), Style::new(Color::new(101, 74, 150), false, false, false, false)),
        ("text.uri".to_owned(), Style::new(Color::new(228, 220, 236), false, false, false, false)),
        ("text.title".to_owned(), Style::new(Color::new(126, 149, 149), false, false, false, false)),
        ("constant.macro".to_owned(), Style::new(Color::new(125, 108, 130), false, false, false, false)),
        ("string.regex".to_owned(), Style::new(Color::new(179, 230, 230), false, false, false, false)),
        ("label".to_owned(), Style::new(Color::new(126, 97, 178), false, false, false, false)),
        ("function.macro".to_owned(), Style::new(Color::new(110, 172, 184), false, false, false, false)),
        ...
        ("type.qualifier".to_owned(), Style::new(Color::new(99, 176, 176), false, false, true, false)),
        ("symbol".to_owned(), Style::new(Color::new(156, 117, 221), false, false, false, false)),
        ("float".to_owned(), Style::new(Color::new(200, 207, 210), false, false, false, false)),
        ("function".to_owned(), Style::new(Color::new(110, 172, 184), false, false, false, false)),
        ("string.special".to_owned(), Style::new(Color::new(179, 230, 230), false, false, false, false)),
        ...
        ("punctuation.delimiter".to_owned(), Style::new(Color::new(143, 143, 183), false, false, false, false)),
        ...
        ("string.escape".to_owned(), Style::new(Color::new(179, 230, 230), false, false, false, false)),
        ("attribute".to_owned(), Style::new(Color::new(99, 176, 176), false, false, false, false)),
        ("function.call".to_owned(), Style::new(Color::new(110, 172, 184), false, false, false, false)),
        ("method.call".to_owned(), Style::new(Color::new(161, 180, 184), false, false, true, false)),
        ("method".to_owned(), Style::new(Color::new(161, 180, 184), false, false, true, false)),
        ("function.builtin".to_owned(), Style::new(Color::new(116, 138, 144), false, false, false, false)),
        ("string".to_owned(), Style::new(Color::new(179, 230, 230), false, false, false, false)),
        ...
        ("annotation".to_owned(), Style::new(Color::new(99, 176, 176), false, false, false, false)),
        ...
        ("error".to_owned(), Style::new(Color::new(213, 168, 228), false, false, false, false)),
        ("text.warning".to_owned(), Style::new(Color::new(63, 52, 66), false, false, false, false)),
        ("text.note".to_owned(), Style::new(Color::new(93, 111, 116), false, false, false, false)),
        ("text.danger".to_owned(), Style::new(Color::new(182, 166, 212), false, false, false, false)),
        ...
        ("text.strong".to_owned(), Style::new(Color::new(228, 220, 236), false, false, false, false)),
        ("text.emphasis".to_owned(), Style::new(Color::new(228, 220, 236), false, false, false, false)),
        ("number".to_owned(), Style::new(Color::new(200, 207, 210), false, false, false, false)),
        ("constructor".to_owned(), Style::new(Color::new(99, 176, 176), false, false, false, false)),
        ("field".to_owned(), Style::new(Color::new(93, 111, 116), false, false, false, false)),
        ("property".to_owned(), Style::new(Color::new(115, 141, 141), false, false, false, false)),
        ...
        ("variable".to_owned(), Style::new(Color::new(154, 204, 204), false, false, false, false)),
